...
namespace NightCycle
{
        ...
        /*void DisableCurrentInteractable()
    {
        ...
        if (currentInteractable)
        {
            ...
            if (PlayerStateController.Instance.CurrentMode != PlayerMode.ItemSelection && PlayerStateController.Instance.CurrentMode != PlayerMode.Assembly) // � ItemSelectionMode ���������� ����������
            {
                //Debug.Log(inventoryUI.currentMode);
