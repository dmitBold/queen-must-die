...
public class InventoryUI : MonoBehaviour
{
    ...
    public void Init(InventoryManager inventory, DayCycleController dayCycle)
    {
    ...
    void TryInit()
    {
        //Debug.Log("[InventoryUI] TryInit called");

        if (InventoryManager.Instance == null)
        {
            //Debug.Log("[InventoryUI] InventoryManager.Instance == NULL");
            return;
        }

       // Debug.Log($"[InventoryUI] Found InventoryManager ID = {InventoryManager.Instance.GetInstanceID()}");

        if (inventory != null)
        {
            //Debug.Log("[InventoryUI] inventory already bound");
            return;
        }

        inventory = InventoryManager.Instance;
        //Debug.Log("[InventoryUI] BOUND SUCCESS");
        Debug.Log(InventoryManager.Instance.Items.Count + "AAAAAAAAAAAAAAAAAAAAAAAa");
        //test
        //inventory.OnInventoryChanged += Refresh;
        //test
    }
